      ...
      <div className="w-11/12 md:w-1/2 lg:w-1/3">
        <form className="bg-gray-100 shadow-md rounded-lg px-8 pt-20 pb-20 lg:pl-20 lg:pr-20" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            ...
            <button onClick={() => { route.push('/user') }} type="submit" className="bg-red-600 rounded-full hover:bg-gray-500 text-white font-bold py-2 px-4 focus:outline-none focus:shadow-outline" >ยกเลิก</button>
          </div>
        </form>
      </div>
    </div>
